    ...
    try {
      ...
      if (result.success) {
        ...
        FirebaseCrashlytics.instance.log(
          'Backend sync failed for email: $email',
        );
      }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildField('Email', 'Enter your email', _idController),
                ...
                Row(
                  ...
                  children: [
                    TextButton(
                      onPressed: () {
                        setState(() {
                          _idController.text = 'admin@fpt.edu.vn';
                    ...
                    TextButton(
                      onPressed: () {
                        setState(() {
                          _idController.text = 'gv1234@fpt.edu.vn';
                          _passwordController.text = '123456';
                        });
                      },
                      child: const Text(
